...
export const key = "dsl.party.sheet";
export const options = { displayName: "DSL: Party: Sheet" };
...
export default ({ describe, it, expect, assert, after }: QuenchMethods) => {
  describe("defaultOptions()", () => {
    it("Has correctly set defaultOptions", () => {
      ...
      expect(partySheet.options.classes).contain("dsl");
  ...
  describe("partySheet()", () => {
    it("Returns a partysheet", () => {
      const { partySheet } = DslPartySheet;
