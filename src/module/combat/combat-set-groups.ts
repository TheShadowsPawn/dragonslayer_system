...
export default class DSLCombatGroupSelector extends HandlebarsApplicationMixin(ApplicationV2) {
  _highlighted;
  ...
  static DEFAULT_OPTIONS = {
      ...
      window: {
        frame: true,
        positioned: true,
        title: "DSL.combat.SetCombatantGroups",
        icon: "fa-flag",
        controls: [],
        minimizable: false,
        resizable: true,
  ...
  static PARTS = {
    main: {
      template: `/systems/DSL-dev/dist/templates/apps/combat-set-groups.hbs`
    }
  }
