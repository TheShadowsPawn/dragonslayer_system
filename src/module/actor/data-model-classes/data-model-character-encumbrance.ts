 ...
 */
export default class DslDataModelCharacterEncumbrance
  implements CharacterEncumbrance
{
  ...
  get #delta() {
    return this.max - DslDataModelCharacterEncumbrance.baseEncumbranceCap;
  }
  ...
  get atHalfEncumbered() {
    return (
      this.value >
      this.max *
        (DslDataModelCharacterEncumbrance.encumbranceSteps.half / 100) +
        (this.#delta || 0)
    );
  }
  ...
  get atThreeEighthsEncumbered() {
    return (
      this.value >
      this.max *
        (DslDataModelCharacterEncumbrance.encumbranceSteps.threeEighths / 100) +
        (this.#delta || 0)
    );
  }
  ...
  get atQuarterEncumbered() {
    return (
      this.value >
      this.max *
        (DslDataModelCharacterEncumbrance.encumbranceSteps.quarter / 100) +
        (this.#delta || 0)
    );
  }
  ...
  get atFiveEighthsEncumbered() {
    return (
      this.value >
      this.max *
        (DslDataModelCharacterEncumbrance.encumbranceSteps.fiveEighths / 100)
    );
  }
  ...
  get atThreeQuartersEncumbered() {
    return (
      this.value >
      this.max *
        (DslDataModelCharacterEncumbrance.encumbranceSteps.threeQuarters / 100)
    );
  }
  ...
  get atSevenEighthsEncumbered() {
    return (
      this.value >
      this.max *
        (DslDataModelCharacterEncumbrance.encumbranceSteps.sevenEighths / 100)
    );
  }
  ...
  get atOneThirdEncumbered() {
    return (
      ...
      Math.round(
        this.max *
          (DslDataModelCharacterEncumbrance.encumbranceSteps.oneThird / 100)
      )
    );
  }
  ...
  get atFiveNinthsEncumbered() {
    return (
      ...
      Math.round(
        this.max *
          (DslDataModelCharacterEncumbrance.encumbranceSteps.fiveNinths / 100)
      )
    );
  }
  ...
  get atSevenNinthsEncumbered() {
    return (
      ...
      Math.round(
        this.max *
          (DslDataModelCharacterEncumbrance.encumbranceSteps.sevenNinths / 100)
      )
    );
  }
}
