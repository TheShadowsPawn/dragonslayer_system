...
export const key = "dsl.actor.datamodel.character.encumbrance";
export const options = {
  displayName: "DSL: Actor: Data Model: Character Encumbrance",
};
...
export default ({ describe, it, expect }: QuenchMethods) => {
  describe("Disabled Encumbrance", () => {
    it("Is disabled", () => {
      let enc = new DslDataModelCharacterEncumbrance();
  ...
  describe("Basic Encumbrance", () => {
    ...
    it("Returns max carry weight", () => {
      ...
      expect(enc.max).to.equal(
        DslDataModelCharacterEncumbrance.baseEncumbranceCap
      );
    });
  });
  ...
  describe("Detailed Encumbrance", () => {
    ...
    it("Returns the appropriate encumbrance steps", () => {
      ...
      expect(enc.steps).to.have.members(
        Object.values(DslDataModelCharacterEncumbrance.encumbranceSteps)
      );
    });
    describe("Returns current carried weight", () => {
      it("As Percentage", () => {
