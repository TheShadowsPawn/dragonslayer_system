/**
 * @file A class to handle the nested AC/AAC props on DslDataModelCharacter.
 */
...
export default class DslDataModelCharacterAC implements CharacterAC {
  static baseAscending = 10;

  static baseDescending = 10;
  ...
  constructor(isAscending = false, armor: Item[] = [], dexMod = 0, mod = 0) {
    ...
    this.#acProp = this.#isAscending
      ? DslDataModelCharacterAC.propAscending
      : DslDataModelCharacterAC.propDescending;
  }
  ...
  get base() {
    return this.#isAscending
      ? DslDataModelCharacterAC.baseAscending
      : DslDataModelCharacterAC.baseDescending;
  }
