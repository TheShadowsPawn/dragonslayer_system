 ...
 */
export default class DslDataModelCharacterMove implements CharacterMove {
  static baseMoveRate = 40;
   ...
   * The constructor
   *
   * @param {DslDataModelCharacterEncumbrance} encumbrance - An object representing the character's encumbrance values
   ...
   */
  constructor(
    encumbrance: DslDataModelCharacterEncumbrance = new DslDataModelCharacterEncumbrance(),
    shouldCalculateMovement = true,
    base = DslDataModelCharacterMove.baseMoveRate,
