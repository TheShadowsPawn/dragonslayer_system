 ...
 */
export default class DslDataModelCharacterEncumbranceItemBased
  ...
  implements CharacterEncumbrance
{
   ...
   */
  static localizedLabel = "DSL.Setting.EncumbranceItemBased";
  ...
  constructor(max = 16, items: Item[] = []) {
    super(DslDataModelCharacterEncumbranceItemBased.type, max);
  ...
  get steps() {
    return this.usingEquippedEncumbrance
      ? Object.values(
          DslDataModelCharacterEncumbranceItemBased.equippedEncumbranceSteps
        )
      : Object.values(
          DslDataModelCharacterEncumbranceItemBased.packedEncumbranceSteps
        );
  }
