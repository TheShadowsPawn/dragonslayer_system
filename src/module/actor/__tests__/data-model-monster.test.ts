...
import DslDataModelMonster from "../data-model-monster";

export const key = "dsl.actor.datamodel.monster";
export const options = { displayName: "DSL: Actor: Data Model: Monster" };
...
export default ({
  ...
  const dataModel = new DslDataModelMonster();
