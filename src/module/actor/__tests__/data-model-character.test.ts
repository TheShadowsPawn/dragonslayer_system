...
import DslDataModelCharacter from "../data-model-character";

export const key = "dsl.actor.datamodel.character";
export const options = { displayName: "DSL: Actor: Data Model: Character" };

const createMockActor = () => createMockActorKey("character", {}, key);

export default ({ describe, it, expect, after, before }: QuenchMethods) => {
  const dataModel = new DslDataModelCharacter();
