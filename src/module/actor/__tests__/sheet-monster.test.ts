...
import DslActorSheetMonster from "../monster-sheet";

export const key = "dsl.actor.sheet.monster";
export const options = { displayName: "DSL: Actor: Sheet: Monster" };
...
export default ({ describe, it, expect, after, before }: QuenchMethods) => {
  ...
  describe("defaultOptions()", () => {
    it("Has correctly set defaultOptions", async () => {
      ...
      const sheet = actor?.sheet as unknown as DslActorSheetMonster;
