...
export const key = "dsl.actor.sheet.e2e.dragndrop";
export const options = {
  displayName: "DSL: Actor: Sheet E2E Drag'n'Drop",
  preSelected: true,
};
    ...
    itemTypes.forEach((itemType) => {
      ...
      describe(`manipulating ${itemType} item type`, () => {
        ...
        it(`drag ${itemType} from compendium into a container in a character sheet`, async () => {
          ...
          const worldItem = (await createWorldTestItem(itemType)) as DslItem;
