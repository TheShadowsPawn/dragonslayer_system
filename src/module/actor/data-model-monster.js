 ...
 */
// Encumbrance schemes
import DslDataModelCharacterEncumbranceDisabled from "./data-model-classes/data-model-character-encumbrance-disabled";
...
export default class DslDataModelMonster extends foundry.abstract.DataModel {
  prepareDerivedData() {
    this.encumbrance = new DslDataModelCharacterEncumbranceDisabled();
