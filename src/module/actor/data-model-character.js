 ...
 */
import DslDataModelCharacterAC from "./data-model-classes/data-model-character-ac";
import DslDataModelCharacterMove from "./data-model-classes/data-model-character-move";
import DslDataModelCharacterScores from "./data-model-classes/data-model-character-scores";
import DslDataModelCharacterSpells from "./data-model-classes/data-model-character-spells";
...
export default class DslDataModelCharacter extends foundry.abstract.DataModel {
  prepareDerivedData() {
    this.scores = new DslDataModelCharacterScores(this.scores);

    // eslint-disable-next-line new-cap
    this.encumbrance = new CONFIG.DSL.encumbrance(
    ...
    this.movement = new DslDataModelCharacterMove(
      this.encumbrance,
    ...
    this.ac = new DslDataModelCharacterAC(
      false,
      [
    ...
    this.aac = new DslDataModelCharacterAC(
      true,
    ...
    this.spells = new DslDataModelCharacterSpells(this.spells, this.#spellList);
  }
