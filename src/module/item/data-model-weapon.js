 ...
 */
export default class DslDataModelWeapon extends foundry.abstract.DataModel {
  static defineSchema() {
    const {
      SchemaField,
      StringField,
  ...
  get #meleeTag() {
    ...
    return CONFIG.DSL.auto_tags.melee;
  }

  get #slowTag() {
    if (!this.slow) return null;
    return CONFIG.DSL.auto_tags.slow;
  }
