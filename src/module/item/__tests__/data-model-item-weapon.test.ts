...
import DslDataModelWeapon from "../data-model-weapon";

export const key = "dsl.item.datamodel.weapon";
export const options = { displayName: "DSL: Item: Data Model: Weapon" };

export default ({ describe, it, expect }: QuenchMethods) => {
  describe("manualTags()", () => {
    const item = new DslDataModelWeapon();
