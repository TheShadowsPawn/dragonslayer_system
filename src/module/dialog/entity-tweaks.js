...
export default class DslEntityTweaks extends FormApplication {
  static get defaultOptions() {
    const options = super.defaultOptions;
    options.id = "sheet-tweaks";
    options.classes = ["sheet-tweaks"];
    options.template = `${DSL.systemPath()}/templates/actors/dialogs/tweaks-dialog.html`;
    options.width = 380;
    return options;
  }
   ...
   */
  get title() {
    return `${this.object.name}: ${game.i18n.localize("DSL.dialog.tweaks")}`;
  }
